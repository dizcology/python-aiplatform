...
# [START aiplatform_v1beta1_list_artifacts_sample]
from google.cloud import aiplatform_v1beta1


def list_artifacts_sample(
    project: str,
    ...
    response = client.list_artifacts(parent=parent)
    for artifact in response:
        print("artifact:", artifact)


# [END aiplatform_v1beta1_list_artifacts_sample]
