...
# [START aiplatform_v1beta1_deploy_index_sample]
...
def deploy_index_sample(
    ...
    deploy_index_response = response.result(timeout=timeout)
    print("deploy_index_response:", deploy_index_response)


# [END aiplatform_v1beta1_deploy_index_sample]
