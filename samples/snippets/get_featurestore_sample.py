...
# [START aiplatform_v1beta1_get_featurestore_sample]
from google.cloud import aiplatform_v1beta1


def get_featurestore_sample(
    project: str,
    featurestore_id: str,
    ...
    response = client.get_featurestore(name=name)
    print("response:", response)


# [END aiplatform_v1beta1_get_featurestore_sample]
