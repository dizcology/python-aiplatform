...
# [START aiplatform_v1beta1_upload_model_custom_container_sample]
from google.cloud import aiplatform_v1beta1


def upload_model_custom_container_sample(
    project: str,
    display_name: str,
...
# [END aiplatform_v1beta1_upload_model_custom_container_sample]
