...
# [START aiplatform_v1beta1_create_artifact_sample]
...
def create_artifact_sample(
    ...
    artifact: google.cloud.aiplatform_v1beta1.types.artifact.Artifact,
    artifact_id: str,
    ...
    response = client.create_artifact(
        parent=parent, artifact=artifact, artifact_id=artifact_id
    )
    print("response:", response)


# [END aiplatform_v1beta1_create_artifact_sample]
