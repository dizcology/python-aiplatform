...
# [START aiplatform_v1beta1_create_tensorboard_sample]
...
def create_tensorboard_sample(
    ...
    create_tensorboard_response = response.result(timeout=timeout)
    print("create_tensorboard_response:", create_tensorboard_response)


# [END aiplatform_v1beta1_create_tensorboard_sample]
