...
# [START aiplatform_v1beta1_create_training_pipeline_video_classification_sample]
...
# [END aiplatform_v1beta1_create_training_pipeline_video_classification_sample]
