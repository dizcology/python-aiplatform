...
# [START aiplatform_v1beta1_check_trial_early_stopping_state_sample]
...
def check_trial_early_stopping_state_sample(
    ...
    print(
        "check_trial_early_stopping_state_response:",
        check_trial_early_stopping_state_response,
    )


# [END aiplatform_v1beta1_check_trial_early_stopping_state_sample]
