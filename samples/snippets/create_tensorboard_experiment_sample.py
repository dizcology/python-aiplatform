...
# [START aiplatform_v1beta1_create_tensorboard_experiment_sample]
...
def create_tensorboard_experiment_sample(
    ...
    response = client.create_tensorboard_experiment(
        parent=parent,
...
# [END aiplatform_v1beta1_create_tensorboard_experiment_sample]
