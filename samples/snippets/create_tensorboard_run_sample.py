...
# [START aiplatform_v1beta1_create_tensorboard_run_sample]
from google.cloud import aiplatform_v1beta1


def create_tensorboard_run_sample(
    project: str,
    tensorboard_id: str,
    experiment_id: str,
    ...
    response = client.create_tensorboard_run(
        parent=parent,
...
# [END aiplatform_v1beta1_create_tensorboard_run_sample]
