...
# [START aiplatform_v1beta1_create_training_pipeline_text_entity_extraction_sample]
...
def create_training_pipeline_text_entity_extraction_sample(
    ...
    training_task_inputs = (
        trainingjob.definition.AutoMlTextExtractionInputs().to_value()
    )
...
# [END aiplatform_v1beta1_create_training_pipeline_text_entity_extraction_sample]
