...
# [START aiplatform_v1beta1_create_context_sample]
...
def create_context_sample(
    ...
    context: google.cloud.aiplatform_v1beta1.types.context.Context,
    context_id: str,
    ...
    response = client.create_context(
        parent=parent, context=context, context_id=context_id
    )
    print("response:", response)


# [END aiplatform_v1beta1_create_context_sample]
