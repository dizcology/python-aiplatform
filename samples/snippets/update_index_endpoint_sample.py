...
# [START aiplatform_v1beta1_update_index_endpoint_sample]
...
def update_index_endpoint_sample(
    ...
    response = client.update_index_endpoint(
        index_endpoint=index_endpoint, update_mask=update_mask
    )
    print("response:", response)


# [END aiplatform_v1beta1_update_index_endpoint_sample]
