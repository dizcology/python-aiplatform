...
# [START aiplatform_v1beta1_batch_create_features_sample]
...
def batch_create_features_sample(
    ...
    response = client.batch_create_features(parent=parent, requests=requests)
    print("Long running operation:", response.operation.name)
    batch_create_features_response = response.result(timeout=timeout)
    print("batch_create_features_response:", batch_create_features_response)


# [END aiplatform_v1beta1_batch_create_features_sample]
