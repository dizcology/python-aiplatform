...
# [START aiplatform_v1beta1_create_training_pipeline_video_object_tracking_sample]
...
# [END aiplatform_v1beta1_create_training_pipeline_video_object_tracking_sample]
