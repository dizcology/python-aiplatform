...
# [START aiplatform_v1beta1_create_entity_type_sample]
...
def create_entity_type_sample(
    project: str,
    featurestore_id: str,
    entity_type: google.cloud.aiplatform_v1beta1.types.entity_type.EntityType,
    ...
    create_entity_type_response = response.result(timeout=timeout)
    print("create_entity_type_response:", create_entity_type_response)


# [END aiplatform_v1beta1_create_entity_type_sample]
